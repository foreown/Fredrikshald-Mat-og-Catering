...
| `/admin/innstillinger`  | Endrer kontaktinfo, sosiale medier, logo og bedriftsopplysninger |
...
│   ├── social.ts             # listen over sosiale medier dere kan velge mellom
...
**Innstillinger.** E-post, telefon, adresse, organisasjonsnummer og logo.

**Sosiale medier** (nederst under Innstillinger). Velg plattform fra listen —
Instagram, Facebook, TikTok, Snapchat, YouTube, X, Threads, LinkedIn,
Pinterest, WhatsApp, Messenger, Google-bedriftsprofil, Trustpilot, Vipps eller
en hvilken som helst annen nettside — skriv brukernavnet, så foreslår systemet
lenken for deg. Lenkene vises som ikoner i footeren og i listen på
kontaktsiden, i den rekkefølgen du bestemmer.
