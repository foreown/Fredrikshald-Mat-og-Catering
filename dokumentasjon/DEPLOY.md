...
| 5          | `supabase/migrations/0005_sosiale_medier.sql` | Sosiale medier                                 |

**Kontroll:** Klikk **Table Editor** i menyen. Du skal se disse tolv
tabellene: `availability_blocks`, `event_types`, `faq_items`, `gallery`,
`gallery_categories`, `menu_categories`, `menu_items`, `profiles`,
`review_submissions`, `reviews`, `site_settings` og `social_links`.
...
- [ ] Alle fem SQL-filene er kjørt uten feil, i riktig rekkefølge
- [ ] Alle tolv tabeller finnes
...
| Legge til Instagram, TikTok, Snapchat … | Innstillinger → Sosiale medier → **Legg til**                     |
| Endre eller fjerne en sosial lenke | Innstillinger → Sosiale medier → **Rediger** eller **Slett**           |
